...
import { Settings, Bell, Shield, Database, Mail, Palette, Save } from "lucide-react"
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input id="company-name" defaultValue="WedoCRM Solutions" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="company-email">Company Email</Label>
                    <Input id="company-email" type="email" defaultValue="admin@fincrm.com" />
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-2">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">Get system updates and announcements</p>
                    </div>
                    <Switch defaultChecked />
                  </div>
                </div>
